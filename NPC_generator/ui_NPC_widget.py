...
class Ui_NPC_Widget(object):
    def setupUi(self, NPC_Widget):
        ...
        self.lineEdit_name_more = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_name_more.setGeometry(QtCore.QRect(0, 19, 171, 21))
        self.lineEdit_name_more.setText("")
        self.lineEdit_name_more.setObjectName("lineEdit_name_more")
        ...
        self.comboBox_weapon1_type_2 = QtWidgets.QComboBox(self.groupBox_weapons_battle)
        self.comboBox_weapon1_type_2.setGeometry(QtCore.QRect(0, 59, 91, 20))
        self.comboBox_weapon1_type_2.setStyleSheet("")
        self.comboBox_weapon1_type_2.setObjectName("comboBox_weapon1_type_2")
        self.comboBox_weapon1_type_2.addItem("")
        self.comboBox_weapon1_type_2.addItem("")
        self.comboBox_weapon1_type_2.addItem("")
        self.comboBox_weapon1_type_2.addItem("")
        self.comboBox_weapon1_type_2.addItem("")
        ...
        self.comboBox_weapon1_type_2.raise_()
    ...
    def retranslateUi(self, NPC_Widget):
        ...
        self.comboBox_type.setItemText(0, _translate("NPC_Widget", "NPC type"))
        ...
        self.comboBox_weapon1_type.setItemText(1, _translate("NPC_Widget", "Без оружия"))
        self.comboBox_weapon1_type.setItemText(2, _translate("NPC_Widget", "Кастет"))
        self.comboBox_weapon1_type.setItemText(3, _translate("NPC_Widget", "Кинжал"))
        self.comboBox_weapon1_type.setItemText(4, _translate("NPC_Widget", "Меч"))
        self.comboBox_weapon1_type.setItemText(5, _translate("NPC_Widget", "Копьё"))
        self.comboBox_weapon1_type.setItemText(6, _translate("NPC_Widget", "Топор"))
        self.comboBox_weapon1_type.setItemText(7, _translate("NPC_Widget", "Молот"))
        self.comboBox_weapon1_type.setItemText(8, _translate("NPC_Widget", "2хПосох"))
        self.comboBox_weapon1_type.setItemText(9, _translate("NPC_Widget", "2хКопьё"))
        self.comboBox_weapon1_type.setItemText(10, _translate("NPC_Widget", "2хМеч"))
        self.comboBox_weapon1_type.setItemText(11, _translate("NPC_Widget", "2хТопор"))
        self.comboBox_weapon1_type.setItemText(12, _translate("NPC_Widget", "2хМолот"))
        self.comboBox_weapon1_type.setItemText(13, _translate("NPC_Widget", "Метать"))
        self.comboBox_weapon1_type.setItemText(14, _translate("NPC_Widget", "Пистолет"))
        self.comboBox_weapon1_type.setItemText(15, _translate("NPC_Widget", "2хПраща"))
        self.comboBox_weapon1_type.setItemText(16, _translate("NPC_Widget", "2хЛук"))
        self.comboBox_weapon1_type.setItemText(17, _translate("NPC_Widget", "2хАрбалет"))
        self.comboBox_weapon1_type.setItemText(18, _translate("NPC_Widget", "2хРужьё"))
        ...
        self.comboBox_weapon1_type_2.setItemText(0, _translate("NPC_Widget", "type"))
        self.comboBox_weapon1_type_2.setItemText(1, _translate("NPC_Widget", "Без оружия"))
        self.comboBox_weapon1_type_2.setItemText(2, _translate("NPC_Widget", "Занято"))
        self.comboBox_weapon1_type_2.setItemText(3, _translate("NPC_Widget", "Щит"))
        self.comboBox_weapon1_type_2.setItemText(4, _translate("NPC_Widget", "Кастет"))
        self.comboBox_weapon1_type_2.setItemText(5, _translate("NPC_Widget", "Кинжал"))
        self.comboBox_weapon1_type_2.setItemText(6, _translate("NPC_Widget", "Меч"))
        self.comboBox_weapon1_type_2.setItemText(7, _translate("NPC_Widget", "Копьё"))
        self.comboBox_weapon1_type_2.setItemText(8, _translate("NPC_Widget", "Топор"))
        self.comboBox_weapon1_type_2.setItemText(9, _translate("NPC_Widget", "Молот"))
        self.comboBox_weapon1_type_2.setItemText(10, _translate("NPC_Widget", "Метать"))
        self.comboBox_weapon1_type_2.setItemText(11, _translate("NPC_Widget", "Пистолет"))
