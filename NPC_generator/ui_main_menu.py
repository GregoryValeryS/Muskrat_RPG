...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser_battlelog = QtWidgets.QTextBrowser(self.groupBox_battlelog)
        self.textBrowser_battlelog.setGeometry(QtCore.QRect(0, 20, 261, 341))
        self.textBrowser_battlelog.setObjectName("textBrowser_battlelog")
